...
describe("Auth config", () => {
  ...
  test.each([
    ...
    process.env.RPA_GET_PERSON_SUMMARY_URL =
      testCase.processEnv.rpaGetPersonSummaryUrl;
    process.env.RPA_GET_ORGANISATION_PERMISSIONS_URL =
      testCase.processEnv.rpaGetOrganisationPermissionsUrl;
    process.env.RPA_GET_ORGANISATION_URL =
      testCase.processEnv.rpaGetOrganisationUrl;
    process.env.RPA_GET_CPH_NUMBERS_URL =
      testCase.processEnv.rpaGetCphNumbersUrl;
    process.env.APIM_OCP_SUBSCRIPTION_KEY =
      testCase.processEnv.apimOcpSubscriptionKey;
