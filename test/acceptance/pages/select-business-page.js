...
const HEADER_HISTORY_DASHBOARD_ACTUAL='//h3[@class="govuk-heading-m govuk-!-static-margin-top-2"]'
const HEADER_HISTORY_DASHBOARD_EXPECTED='Your previous claims'
const HISTORY_MESSAGE_ACTUAL='//*[@id="main-content"]/div[2]/div/p[1]'
const HISTORY_MESSAGE_EXPECTED='Your claims will appear here when you have made them'
//const ELEMENT_SCROLL_HEADER= '//h3[@class="govuk-heading-m govuk-!-static-margin-top-4"]'
const TERMS_AND_CONDITIONS_LINK_TEXT_ACTUAL='//a[text()="Terms and conditions for reviewing the health and welfare of your livestock"]'
const TERMS_AND_CONDITIONS_LINK_TEXT_EXPECTED='Terms and conditions for reviewing the health and welfare of your livestock'
const GUIDANCE_FOR_REVIEW_LINK_TEXT_ACTUAL='//a[text()="Guidance for reviewing the health and welfare of your livestock"]'
const GUIDANCE_FOR_REVIEW_LINK_TEXT_EXPECTED='Guidance for reviewing the health and welfare of your livestock'
...
async validate_manage_your_claims_page(){
  await this.elementToContainText(HEADER_MANAGE_YOUR_CLAIMS_ACTUAL,HEADER_MANAGE_YOUR_CLAIMS_EXPECTED)
}

async validate_your_previous_claims_text_header(){
  await this.elementToContainText(HEADER_HISTORY_DASHBOARD_ACTUAL,HEADER_HISTORY_DASHBOARD_EXPECTED)
}

async validate_dashboard_history_message(){
  await this.elementToContainText(HISTORY_MESSAGE_ACTUAL,HISTORY_MESSAGE_EXPECTED)
}
...
async validate_terms_and_conditions_link_exists(){
  await this.elementToContainText(TERMS_AND_CONDITIONS_LINK_TEXT_ACTUAL,TERMS_AND_CONDITIONS_LINK_TEXT_EXPECTED)
}
async validate_guidance_for_review_link_exists(){
  await this.elementToContainText(GUIDANCE_FOR_REVIEW_LINK_TEXT_ACTUAL,GUIDANCE_FOR_REVIEW_LINK_TEXT_EXPECTED)
}
async validate_agreement_summary_link_exists(){
  await this.elementToContainText(AGREEMENT_SUMMARY_ACTUAL,AGREEMENT_SUMMARY_EXPECTED)
}
async validate_feedback_link_exists(){
  await this.elementToContainText(FEEDBACK_LINK_ACTUAL,FEEDBACK_LINK_EXPECTED)
}
